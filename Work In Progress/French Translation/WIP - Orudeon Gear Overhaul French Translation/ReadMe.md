## *Orudeon's Gear Overhaul* Traduction Française

Vous jouez à *Borderlands 2* en version Française et vous avez entièrement raison car les acteurs de doublage Français (Christophe Lemoine pour *Le Beau Jack*, Sophie Riffont pour *Moxxi*, Sylvain Lemarié pour *Marcus Kincaid*, etc...) on fait un excellent travail.

Le Mod *Orudeon's Gear Overhaul Traduction Française* est un simple patch de traduction qui permet d'obtenir en Français tous ajouts de textes (Anglais) du Mod *Orudeon's Gear Overhaul*.

Ce Mod comprend la traduction Française des ajouts Anglais de la version *Gears Overhaul v1.36* incluant:
- Bandit Brand Tweaks V1.2 by Orudeon
- Jakobs Brand Tweaks V1.4 by Orudeon
- Tediore Brand Overhaul V1.35 by Orudeon
- Shield Behavior Overhaul V1.3 by Orudeon
- Shield Stat Tweaks v1.2 by Orudeon
- Prefix Rework V2.1 by AngrierPat
- Relic Overhaul V1.1 by Orudeon
...
- 100% compatible avec:
  ...
  - la dernière version de [Gear Overhaul 1.36](https://github.com/BLCM/BLCMods/blob/master/Borderlands%202%20mods/Orudeon/Gear%20Overhaul%201.36.txt) by [Orudeon](https://github.com/BLCM/BLCMods/tree/master/Borderlands%202%20mods/Orudeon)

:warning: N'oubliez pas de placer ce Mod __APRES__ le Mod *Orudeon's Gears Overhaul v1.36* :warning:
