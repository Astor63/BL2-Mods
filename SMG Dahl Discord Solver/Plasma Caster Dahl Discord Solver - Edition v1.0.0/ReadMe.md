...
## Plasma Caster Dahl Discord Solver (Bloody Edition)
 
In their early days in their making of weapons, Dahl, in collaboration with Torgue created the Discord Solver, a Plasma Caster who shot Power Rocket GyroJet explosive bullet. 

Unfortunately, the agreement between the two weapons manufacturers did not last long, and the production of the Plasma Caster stopped quickly -How ironic for a weapon that's named Discord Solver!- and Torgue seized the patents to create the Pocket Rocket.
...
- Plasma Caster FireMode (slighty) modified to shoot the Pocket Rocket GyroJet Explosive Bullet.   
- The speed from the Pocket Rocket GyroJet Explosive bullet is 3x faster when fired by a Plasma Caster than a pistol (but it's still a lot more slower than a normal bullet fired by a SMG) 
 ...
 - MuzzleFlash upgraded to Explosive Plasma.
...
| ~~Bladed Lascaux~~       | **No blade on SMG E-Tech**          | ~~BL2(hwAAAADydgBB6ANBBIFEcmIpwQKNJQGLChYGLBJY/v8vY4nBYo3l)~~  |
...
- Just be aware from the following:
  ...
  ``` 
  - This mod use the *Pocket Rocket GyroJet Firing Mode*, so if you use any mode that changes the attributes from the Pocket Rocket GyroJet Firing Mode, it will affect this mod, and obviously the firing of the Discord Solver. In this case, Just revert the modification done previously to the Pocket Rocket GyroJet Firing Mode.
...
A great mod to check for the Plasma Caster Discord Solver:

- [More Blood](https://github.com/BLCM/BLCMods/blob/a3706b44e0ab31632eb04bdc5056b57ae66f3a27/Borderlands%202%20mods/Juso/moreblood.blcm) by [Juso](https://github.com/BLCM/BLCMods/tree/a3706b44e0ab31632eb04bdc5056b57ae66f3a27/Borderlands%202%20mods/Juso) : To have more fun when you will explode your enemys.
